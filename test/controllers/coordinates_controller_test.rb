...
class CoordinatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinate" do
    assert_difference('Coordinate.count') do
      post coordinates_url, params: { coordinate: { content: @coordinate.content, image: @coordinate.image, title: @coordinate.title } }
    end
  ...
  test "should update coordinate" do
    patch coordinate_url(@coordinate), params: { coordinate: { content: @coordinate.content, image: @coordinate.image, title: @coordinate.title } }
